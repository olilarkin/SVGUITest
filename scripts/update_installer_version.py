...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SVGUITest Demo Installer\n"
      else:
        line="OutputBaseFilename=SVGUITest Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SVGUITest Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SVGUITest installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SVGUITest Demo installer\n"
     else:
       line="SetupWindowTitle=SVGUITest installer\n"
