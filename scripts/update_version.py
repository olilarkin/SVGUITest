...
def main():
  ...
  plistpath = scriptpath + "/resources/SVGUITest-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SVGUITest-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SVGUITest-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SVGUITest-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SVGUITest-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SVGUITest.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SVGUITest.iss",inplace=1):
